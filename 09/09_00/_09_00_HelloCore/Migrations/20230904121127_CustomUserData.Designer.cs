...
namespace _09_00_HelloCore.Migrations
{
    ...
    [Migration("20230904121127_CustomUserData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.Bestelling", b =>
                {
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.CustomUser", b =>
                {
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.Klant", b =>
                {
                    b.Property<int>("KlantID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.OrderLijn", b =>
                {
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.Bestelling", b =>
                {
                    b.HasOne("_09_00_HelloCore.Models.Klant", "klant")
                        .WithMany("bestelling")
            ...
            modelBuilder.Entity("_09_00_HelloCore.Models.OrderLijn", b =>
                {
                    b.HasOne("_09_00_HelloCore.Models.Bestelling", "bestelling")
                        .WithMany("orderlijnen")
                        .HasForeignKey("BestellingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_09_00_HelloCore.Models.Product", "product")
                        .WithMany("orderlijnen")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("_09_00_HelloCore.Models.CustomUser", null)
                        .WithMany()
