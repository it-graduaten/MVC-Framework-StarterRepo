...
INSERT INTO [dbo].[Categorie] ([CategorieId], [Naam], [Beschrijving]) VALUES (1, 'Kleding', 'Dit zijn alle truien, tshirts en broeken')
INSERT INTO [dbo].[Categorie] ([CategorieId], [Naam], [Beschrijving]) VALUES (2, 'Schoenen', 'Dit zijn alle soorten schoenen')
INSERT INTO [dbo].[Categorie] ([CategorieId], [Naam], [Beschrijving]) VALUES (3, 'Laptops', 'Dit zijn de laptops en notebooks')
INSERT INTO [dbo].[Categorie] ([CategorieId], [Naam], [Beschrijving]) VALUES (4, 'Desktops', 'Dit zijn vaste computers')
